# ⚡ Taller de Power BI | Análisis de Comercio Electrónico  
## Proyecto Bolt
...
En este proyecto se desarrolló un **tablero interactivo en Power BI** para una empresa ficticia llamada **Bolt**, especializada en productos para el hogar.

Durante este ejercicio práctico se aplicaron distintas técnicas para:

- Evaluar el rendimiento de las categorías de productos.
- Comparar las ventas actuales con los datos del año anterior.
- Implementar análisis de escenarios para simular distintos contextos de negocio.
- Aplicar medidas avanzadas en **DAX** para lograr cálculos más precisos.

Este proyecto permitió consolidar conocimientos en **optimización de modelos, visualización avanzada y storytelling con datos**, asegurando que los paneles no solo sean informativos, sino también intuitivos y visualmente atractivos.

---

## 🔗 Ver Tablero

🔗 *(Agrega aquí el enlace a Power BI Service o archivo compartido)*

---

## 🎯 Habilidades Destacadas

- Creación de **cuadros de mando profesionales** alineados con las necesidades del negocio.
...
- Aplicación de **automatización y optimización de procesos** con Power Query.
...
- ✅ Creación de cuadros de mando intuitivos y **orientados a la toma de decisiones**.
...
- ✅ Implementación de gráficos avanzados como:
  - Gráfico de **mancuernas** para comparación de valores.
  - **Bullet Chart** para evaluación de KPIs.
...
- ✅ Implementación de funciones de **Time Intelligence** para comparaciones temporales.
- ✅ Optimización de cálculos para mejorar el **rendimiento del tablero**.
- ✅ Uso de atajos y buenas prácticas para acelerar el desarrollo en Power BI.

---

🚀 **Proyecto enfocado en análisis de negocio, visualización avanzada y toma de decisiones basada en datos.**
